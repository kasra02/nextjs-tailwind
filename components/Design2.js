...
const Design2 = () => {
    return (
        <div className="my-5 mx-3 bg-white rounded-tr-md rounded-tl-md overflow-hidden">
            <div className="w-full h-56 relative">
                <Image src="/design2/images/image-product-mobile.jpg" layout="fill"   objectFit="cover" objectPosition="top"  />
            </div>
            <div className="flex flex-col bg-white px-3">
                ...
                <p className="mt-3 text-design2-Dark-grayish-blue font-montserrat font-medium">A floral, solar and voluptuous interpretation composed by Oliver Polge, Perfumer-creator for the house of CHANEL</p>
